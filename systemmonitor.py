...
class CpuTimeSnapshot:
    __slots__ = ['_timestamp', '_user', '_system', '_idle']
    file_name = 'cpu_time.csv'
    csv_header = ['timestamp', 'user', 'system', 'idle']

    def __init__(self, timestamp, user, system, idle):
    ...
    def vars_to_array(self):
        return [self._timestamp, self._user, self._system, self._idle]
